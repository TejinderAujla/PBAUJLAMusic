...
For Help : @HEARTBROKENPERSON1**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✚ 𝐀𝐃𝐃 🅐𝖚𝖏𝖑𝖆 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                ],[
                    InlineKeyboardButton("👤 𝐁𝐎𝐓 𝐎𝐖𝐍𝐄𝐑", url=f"https://t.me/{OWNER_USERNAME}"),
                    InlineKeyboardButton("📢 𝐒𝐎𝐔𝐑𝐂𝐄", url=f"https://github.com/TejinderAujla/PBAUJLAMUSIC")
                ],[
                    InlineKeyboardButton("📨 𝐆𝐑𝐎𝐔𝐏", url=f"https://t.me/Lions_OF_Punjab"),
                    InlineKeyboardButton("📨 𝐂𝐇𝐀𝐍𝐍𝐄𝐋", url=f"https://t.me/AujlaPB65_Network")
                ],[
